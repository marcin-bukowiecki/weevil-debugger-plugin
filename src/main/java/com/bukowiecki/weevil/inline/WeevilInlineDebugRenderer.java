...
public final class WeevilInlineDebugRenderer implements EditorCustomElementRenderer {
  ...
  WeevilInlineDebugRenderer(XValueNodeImpl valueNode,
                          @NotNull XSourcePosition position,
                          @NotNull XDebugSession session,
                          Editor editor) {
    myPosition = position;
    mySession = session;
    myCustomNode = true;//valueNode instanceof InlineWatchNodeImpl;
  ...
  private void handleClick(Inlay<?> inlay) {
    WeevilInlineDebugRenderer inlayRenderer = (WeevilInlineDebugRenderer)inlay.getRenderer();
  ...
  private void setHovered(boolean active, Inlay<?> inlay, EditorEx editorEx) {
    ...
    editorEx.setCustomCursor(WeevilInlineDebugRenderer.class, cursor);
    if (oldState != active) {
      inlay.update();
    }
  }
